...
export default function CpblModelDetails({game}:{game:PregameGame}){
 ...
 return <details className="rounded-lg border border-slate-600 bg-slate-900/50">
  ...
  <div className="space-y-3 px-4 pb-4 text-sm text-slate-300">
   ...
   <p>每局得分率＝（己方得分能力 × 50% ＋ 對方團隊失分 × 25% ＋ 對方投手失分估值 × 25%）÷ 9。權重是初始假設。本季至少 20 場；主客場分項至少 10 場，加上 20 場本季均值收縮。</p>
   ...
   <p>日誌的先發投球負荷只採近 60 日最多 5 場先發登板（至少 3 場，限制 3–7 局），不足時暫設 5 局。每局採獨立 Poisson 分布，上半為前 5 局。主隊領先不打九下；再見得分簡化為領先 1 分，未包含再見全壘打多得分。近期後援局數已彙整，疲勞係數、打線、天氣、球場及傷停尚未建模。</p>
