...
export default function Super007({data,error,now}:{data:any;error:string;now:number}){
 ...
 return <details open className="panel p-4"><summary className="cursor-pointer font-bold">Super007 盤口</summary><div className="mt-3 space-y-3">
