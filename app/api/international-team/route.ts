...
export async function GET(request:Request){
 ...
 const data=await pending.get(key);return Response.json(data,{status:data.status==='unavailable'?503:200,headers:{'Cache-Control':'no-store'}});
}
