...
const leagueAliases:Record<string,Record<string,string>>={
 CPBL:{'統一7-ELEVEn獅':'統一獅','統一7-ELEVEN獅':'統一獅','統一':'統一獅','臺鋼雄鷹':'台鋼雄鷹'},
 NPB:{'東北樂天鷹':'東北樂天金鷲','東北樂天金鷹':'東北樂天金鷲','樂天金鷹':'東北樂天金鷲','樂天金鷲':'東北樂天金鷲'},
 KBO:{'起亞老虎':'起亞虎','起亞':'起亞虎','KIA 老虎':'起亞虎','KIA虎':'起亞虎','鬥山熊':'斗山熊','鬥山':'斗山熊','斗山':'斗山熊','英雄':'培證英雄','培證':'培證英雄','恐龍':'NC 恐龍','巫師':'KT 巫師','登陸者':'SSG 登陸者','雙子':'LG 雙子','三星獅子':'三星獅','KT巫師':'KT 巫師','LG雙子':'LG 雙子','NC恐龍':'NC 恐龍','SSG登陸者':'SSG 登陸者'},
};
